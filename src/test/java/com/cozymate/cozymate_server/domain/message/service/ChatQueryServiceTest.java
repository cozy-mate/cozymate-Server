...
//        memberAChat1 = ChatFixture.정상_1(memberA, messageRoom);
//        memberBChat1 = ChatFixture.정상_2(memberB, messageRoom);
//        memberAChat2 = ChatFixture.정상_3(memberA, messageRoom);
...
//            // given
//            given(chatRoomRepositoryService.getChatRoomByIdOrThrow(messageRoom.getId())).willReturn(messageRoom);
//            given(chatRepositoryService.getChatListByChatRoom(messageRoom)).willReturn(chatList);
//
//            // when
//            ChatListResponseDTO result = chatQueryService.getChatList(memberA, messageRoom.getId());
//
//            // then
...
//            // given
//            messageRoom = ChatRoomFixture.정상_4(memberA);
//            given(chatRoomRepositoryService.getChatRoomByIdOrThrow(messageRoom.getId())).willReturn(messageRoom);
//            memberBChat1 = ChatFixture.정상_4(messageRoom);
//            chatList = List.of(memberAChat1, memberBChat1, memberAChat2);
//            given(chatRepositoryService.getChatListByChatRoom(messageRoom)).willReturn(chatList);
//
//            // when
...
//            // when-then
//            assertThatThrownBy(
//                () -> chatQueryService.getChatList(memberC, messageRoom.getId()))
...
//            // given
//            messageRoom = ChatRoomFixture.정상_5(memberB);
//            given(chatRoomRepositoryService.getChatRoomByIdOrThrow(messageRoom.getId())).willReturn(messageRoom);
//
//            // when-then
//            assertThatThrownBy(
