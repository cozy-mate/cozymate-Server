...
//                List<ChatRoomDetailResponseDTO> result = chatRoomQueryService.getChatRoomList(
//                    sender);
//                assertThat(result.size()).isEqualTo(2);
//
//                assertThat(result.get(0).nickname()).isEqualTo(recipient.getNickname());
//                assertThat(result.get(0).lastContent()).isEqualTo(chat2.getContent());
//
//                assertThat(result.get(1).nickname()).isEqualTo(otherMember.getNickname());
//                assertThat(result.get(1).lastContent()).isEqualTo(chat4.getContent());
//            }
//        }
        ...
        class 내가_쪽지방을_삭제한_경우 {
            ...
            class Context_with_no_more_chat_after_delete_chat_room {
                ...
                void it_returns_chat_room_list() {
                    ...
                    assertThat(result.get(0).nickname()).isEqualTo(otherMember.getNickname());
                    assertThat(result.get(0).lastContent()).isEqualTo(chat4.getContent());
                }
            }
