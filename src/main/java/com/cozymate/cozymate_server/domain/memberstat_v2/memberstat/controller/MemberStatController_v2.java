...
import com.cozymate.cozymate_server.domain.memberstat_v2.memberstat.service.MemberStatQueryService_v2;
import com.cozymate.cozymate_server.domain.memberstat_v2.memberstat.service.MemberStatCommandService_v2;
...
public class MemberStatController_v2 {
    ...
    @Operation(
        summary = "[포비] 사용자 상세정보를 키-값으로 필터링하고, 필터링에 맞는 인원 수를 리턴합니다",
        description = "사용자의 토큰을 넣어 사용합니다. " +
