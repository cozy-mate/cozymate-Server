...
public class FieldInstanceResolver {
    ...
    private static final Map<String, BiFunction<Member, MemberStatTest, Object>> FIELD_MAPPER = new HashMap<>();
    ...
    public static Object extractMemberStatField(MemberStatTest memberStat, String fieldName) {
        BiFunction<Member, MemberStatTest, Object> fieldGetter = FIELD_MAPPER.get(fieldName);
        if (fieldGetter == null) {
    ...
    public static Map<String, Object> extractMultiMemberStatFields(MemberStatTest memberStat,
